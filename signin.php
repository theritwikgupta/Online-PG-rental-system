...
<?php include_once('includes/header.php');?>
	...
	<section class="contact-page-area section-gap">
		<div class="container">
			<p style="text-align: center;color: red;font-size: 30px"><strong>Log in Here</strong></p>
			<div class="row mt-80">
				...
				<div class="col-lg-12">
					<form class="row contact_form" action="" method="post" id="" name="login">
						...
						<div class="col-md-6 text-left">
							...
							<button type="submit" value="login" name="login" class="btn primary-btn">Log in</button>
						</div>
						<div class="col-md-6 text-left">
